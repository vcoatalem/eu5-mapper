...
export function ModifierBuffDisplay({ buffKey, buffValue }: { buffKey: keyof IProximityBuffs, buffValue: { buffRecord: Record<string, number>; sum: number } }) {
  const divRef = useRef<HTMLDivElement>(null);
  const buffDisplayableData = countryProximityBuffsDisplayableData[buffKey];
  return (
